...
while true
do
curl -k https://xxcapp.xidian.edu.cn/uc/wap/login/check -d "username=学号&password=统一认证密码" -c cookie -A "Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/75.0.3770.999"
